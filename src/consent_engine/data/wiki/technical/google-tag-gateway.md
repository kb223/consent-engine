...
**GTG is NOT the same as custom sGTM.** This distinction matters for audits.
...
## GTG vs. Non-Compliant Custom sGTM

This is the critical audit distinction:

| Characteristic | GTG (Compliant) | Custom sGTM (Risk) |
|---|---|---|
...
## Identifying GTG vs Non-Compliant sGTM in Audits
...
**Signals suggesting non-compliant sGTM bypass:**
...
Google requires all GTG and sGTM implementations to:
